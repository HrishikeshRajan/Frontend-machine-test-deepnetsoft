  ...
  return (
    ...
    >
       <Card className=' relative border-2  w-full  px-2  xl:px-10 pb-20 flex flex-col justify-center items-center '>
          ...
          <Heading className='text-white w-[300px] sm:w-[600px] xl:w-full text-center text-4xl xl:text-5xl font-extrabold heading-shadow bar '><span>{data.card.title}</span></Heading>
